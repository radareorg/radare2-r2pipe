...
//! Using commands which produce a JSON output is recommended and easier to parse.
//!
...
//!
//! Typically, there are two ways to invoke r2pipe. One by spawning a child-process
//! from inside r2 and second by making the program spawn a child r2process.
//! `enum R2Pipe` is provided to allow easier use of the library and abstract the
